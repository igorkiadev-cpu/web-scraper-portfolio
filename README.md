...
- **Environment Setup** ![env](screenshots/01-terminal-open.png)  
- **Script Execution** ![execution](screenshots/04-running-scraper.png)  
- **Data Extraction** ![data](screenshots/06-data-preview.png)  
- **Output Generation** ![output](screenshots/08-output-files.png)  
- **CSV/XLSX Output Review** ![csv/xlsx](screenshots/11-dataset-xlsx.png)  
